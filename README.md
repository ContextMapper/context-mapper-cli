 ...
 * [TAR](https://repo1.maven.org/maven2/org/contextmapper/context-mapper-cli/6.8.0/context-mapper-cli-6.8.0.tar) (Linux, Mac)
 * [ZIP](https://repo1.maven.org/maven2/org/contextmapper/context-mapper-cli/6.8.0/context-mapper-cli-6.8.0.zip) (Windows)
...
**Gradle:**
```gradle
implementation 'org.contextmapper:context-mapper-cli:6.8.0'
```
